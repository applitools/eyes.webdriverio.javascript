...
class EyesWebElement {
  ...
  constructor(element, eyesDriver, logger) {
    ...
    GeneralUtils.mixin(this, element);
  ...
  static registerSendKeys(element, eyesDriver, logger, args) {
    ...
    return EyesWebElement._getBounds(element).then(function (rect) {
  ...
  sendKeys() {
    ...
    return EyesWebElement.registerSendKeys(that._element, that._eyesDriver, that._logger, args).then(function () {
  ...
  click() {
    ...
    return EyesWebElement.registerClick(that._element, that._eyesDriver, that._logger).then(function () {
  ...
  findElement(locator) {
    ...
    return this._element.findElement(locator).then(function (element) {
      return new EyesWebElement(element, that._eyesDriver, that._logger);
    });
  }
   ...
   */
  async getSize() {
    let size = await this._eyesDriver.getRemoteWebDriver().getElementSize(this._element.selector);
  ...
  async getLocation() {
    ...
    let location = await this._eyesDriver.getRemoteWebDriver().getLocation(this._element.selector);
